...
from core.views import CourseList, AssignmentList, ScorecardRedirectView
...
urlpatterns = [
    ...
    url(r'^grade/(?P<course_number>[a-zA-Z0-9\s]+)/(?P<assignment_name>[a-zA-Z0-9\s]+)/(?P<scorecard_id>[a-z0-9]{8,})/$', AssignmentList.as_view(), name='scorecard-detail'),
]
